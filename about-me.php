...
include "top.php";
?>
<!-- About me page, listing basic information -->
<body>
    <section>
        <h2>About Me</h2>
        <p>
            My name is Jake Ten Eyck, and I am a computer science student at the University of Vermont. I became interested in the topic
            of DCI shows in high school when some of my marching band staff suggested that we try out the activity and see how
